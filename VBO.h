...
struct Vertex {
	Vertex() : Position{}, Normal{}, TexCoords{}, Tangent{}, Bitangent{}
	{
...
public:
	...
	void load(const std::vector<Vertex>& vertices, size_t lenght);
	void loadDynamic(const std::vector<Vertex>& vertices, size_t lenght);
